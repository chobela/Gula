package com.appexpress.gula.service;
...
import com.appexpress.gula.Messages;
...
/*
    ...
    public boolean zzE(Intent intent) {
        ...
        try {
            ...
            int count = sharedPreferences.getInt("badgeCountValue", 0);
            editor.putInt("badgeCountValue", count + 1);
            editor.commit();
            ShortcutBadger.applyCount(getApplicationContext(), count+1);
